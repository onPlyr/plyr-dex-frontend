...
const SwapSelectPage = ({
    ...
    const { filteredTokens, filteredChains, selectedChainId, setSelectedChainId, query, setQuery, maxResults, showMoreResultsButton } = useTokenFilters(tokens)
