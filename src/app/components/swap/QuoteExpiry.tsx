...
interface QuoteExpiryTimerProps extends React.ComponentPropsWithoutRef<typeof motion.circle> {
    pathLength?: number,
}

interface QuoteExpiryProps extends React.ComponentPropsWithoutRef<typeof motion.svg> {
    timerSize?: number,
    timerWidth?: number,
    animationProps?: QuoteExpiryTimerProps,
    trackProps?: React.ComponentPropsWithoutRef<typeof motion.circle>,
}

const QuoteExpiryTimer = React.forwardRef<React.ComponentRef<typeof motion.circle>, QuoteExpiryTimerProps>(({
    fill = "transparent",
...
QuoteExpiryTimer.displayName = "QuoteExpiryTimer"

const QuoteExpiry = React.forwardRef<React.ComponentRef<typeof motion.svg>, QuoteExpiryProps>(({
    className,
    width = "100%",
    height = "100%",
...
QuoteExpiry.displayName = "QuoteExpiry"
